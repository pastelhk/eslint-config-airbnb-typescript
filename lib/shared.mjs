...
function getFlattenRulesFromConfig(config) {
  return Object.values(config).reduce((acc, it) => ({ ...acc, ...it.rules }), {});
}

const baseBestPracticesRules = getFlattenRulesFromConfig(airbnbBase.configs.bestPractices);
...
const baseVariablesRules = getFlattenRulesFromConfig(airbnbBase.configs.variables);
